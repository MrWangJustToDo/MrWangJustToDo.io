...
import { DISABLE_DRAG_HANDLER_SELECTOR, DRAG_HANDLER_SELECTOR, ENABLE_INFINITY_SCROLL, GRID_ROW_HEIGHT } from "config/gridLayout";
...
const GRID_LAYOUTS = {
  lg: [
    { i: "a", x: 0, y: 0, w: 3, h: 40, minW: 2, maxW: 5, minH: 25 },
    {
      i: "b",
      x: 3,
      y: 0,
  ...
  md: [
    { i: "a", x: 0, y: 0, w: 4, h: 30, minW: 2, maxW: 6, minH: 20 },
    {
      i: "b",
      x: 4,
      y: 0,
  ...
  sm: [
    { i: "a", x: 0, y: 0, w: 5, h: 30, minW: 2, maxW: 8, minH: 15 },
    {
      i: "b",
      x: 5,
      y: 0,
