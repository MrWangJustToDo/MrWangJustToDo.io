...
const memoizeCheckFileExist = __DEV__ ? checkFileExist : memoize(checkFileExist, (lang, nameSpace) => `${lang}/${nameSpace}`);
...
const memoizeGetJSONFileContent = __DEV__ ? getJSONFileContent : memoize(getJSONFileContent);
