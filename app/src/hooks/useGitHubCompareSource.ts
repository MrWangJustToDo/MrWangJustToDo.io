...
const temp: GitHubCompareSourceType = { owner: "MrWangJustToDo", repo: "git-diff-view", sourceCommit: "v0.0.13", targetCommit: "main" };

export const useGitHubCompareSource = createState(
  () => ({ owner: "MrWangJustToDo", repo: "git-diff-view", sourceCommit: "v0.0.13", targetCommit: "main", dirty: false }) as GitHubCompareSourceType,
  {
...
export const useGitHubCompareSourceState = () => {
  const { owner, repo, sourceCommit, targetCommit, dirty } = useGitHubCompareSource();
