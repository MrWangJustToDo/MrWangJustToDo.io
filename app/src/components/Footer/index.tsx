...
import { HeartIcon as GoHeartFill } from "lucide-react";
    ...
    <Box textAlign="center">
      <Flex marginTop="6" justifyContent="center" alignItems="center">
        <Text fontSize={{ base: "medium", md: "xl" }} fontWeight="semibold" noOfLines={1} display="flex" alignItems="center">
          ...
          <Icon as={GoHeartFill} color="red.600" mx="0.2em" fill="currentcolor" />
          <Link href="https://nextjs.org/" target="_blank" color="blue.500">
            Next.js
          </Link>
        </Text>
      </Flex>
      <Text fontSize="small" marginTop="2.5" marginBottom="9" color="lightTextColor" as="div">
        <Time />
      </Text>
    </Box>
  );
