...
})()(
  {
          ...
          _createClass(MyReactPureComponent, [
            {
              ...
              value: function shouldComponentUpdate(nextProps, nextState, nextContext) {
                return (
                  ...
                  !(0, _tool.isNormalEqual)(this.context, nextContext)
                );
              },
            },
          ]);
    ...
    8: [
      function (require, module, exports) {
        ...
        exports.warning =
          exports.safeCallWithFiber =
          exports.safeCall =
          exports.getHookTree =
          exports.getFiberTree =
          exports.error =
          exports.debugWithDom =
            void 0;
      ...
      { "./env.js": 19, "./fiber/index.js": 21, "./hook/instance.js": 28 },
    ],
    9: [
      function (require, module, exports) {
        "use strict";
      ...
      { "../fiber/index.js": 21, "../share.js": 37, "./tool.js": 16 },
    ],
    10: [
      function (require, module, exports) {
        "use strict";
      ...
      function (require, module, exports) {
        ...
        var updateDom = function updateDom(element, oldProps, newProps, fiber) {
          if (fiber.__isTextNode__) {
            ...
            Object.keys(oldProps)
              .filter(_prop.isProperty)
              .filter((0, _prop.isGone)(newProps))
              .forEach(function (key) {
                if (key === "className") {
                  if (fiber.nameSpace) {
            ...
            Object.keys(oldProps)
              ...
              .forEach(function (styleKey) {
                Object.keys(oldProps[styleKey] || {})
                  .filter((0, _prop.isGone)(newProps[styleKey] || {}))
          ...
          if (
            ...
            !_env.isHydrateRender.current &&
            !_env.isServerRender.current &&
            (_env.enableHighLight.current || window.__highlight__)
          ) {
    ...
    18: [
      ...
      { "./share.js": 37, "./symbol.js": 38, "./vdom/index.js": 45 },
    ],
    19: [
      function (require, module, exports) {
        "use strict";
        ...
        exports.rootFiber =
          ...
          exports.pendingMountFiberArray =
          exports.pendingLayoutEffectArray =
          exports.pendingEffectArray =
          exports.pendingAsyncModifyTopLevelFiber =
          exports.pendingAsyncModifyFiberArray =
          exports.pendingAsyncModifyFiber =
          exports.nextTransformFiberArray =
          exports.isServerRender =
          exports.isMounted =
          exports.isHydrateRender =
          exports.globalLoop =
          exports.enableKeyDiff =
          exports.enableHighLight =
          exports.enableEventSystem =
          exports.enableDebugLog =
          exports.enableControlComponent =
          exports.enableAsyncUpdate =
          exports.enableAllCheck =
          exports.currentTransformFiberArray =
          exports.currentRunningFiber =
          exports.currentHookDeepIndex =
          exports.currentFunctionFiber =
          exports.asyncUpdateTimeStep =
          exports.asyncUpdateTimeLimit =
            void 0;
    ...
    20: [
      function (require, module, exports) {
        ...
        exports.createUpdatedFiberNodeWithUpdateAndPosition =
          ...
          exports.createUpdatedFiberNode =
          exports.createNewFiberNodeWithPosition =
          exports.createNewFiberNodeWithMount =
          exports.createNewFiberNode =
            void 0;
    ...
    24: [
      ...
      { "../position.js": 32, "../vdom/index.js": 45, "./instance.js": 22 },
    ],
    25: [
      function (require, module, exports) {
        "use strict";
    ...
    26: [
      function (require, module, exports) {
        ...
        function useState(initialValue) {
          var currentHookNode = (0, _create.getHookNode)(
        ...
        function useReducer(reducer, initialArg, init) {
          var currentHook = (0, _create.getHookNode)(
            _env.currentFunctionFiber.current,
            _env.currentHookDeepIndex.current++,
    ...
    28: [
      ...
      { "../fiber/index.js": 21, "../share.js": 37, "../tool.js": 39 },
    ],
    29: [
      function (require, module, exports) {
        "use strict";
    ...
    36: [
      ...
      { "../core/index.js": 6, "../env.js": 19, "../fiber/index.js": 21 },
    ],
    37: [
      function (require, module, exports) {
        "use strict";
        ...
        exports.createRef =
          exports.SORT_BY_DEEP_HEAP =
          exports.NODE_TYPE_KEY =
          exports.MyReactInternalType =
          exports.MyReactInternalInstance =
          exports.IS_UNIT_LESS_NUMBER =
          exports.IS_SINGLE_ELEMENT =
          exports.EMPTY_OBJECT =
          exports.EMPTY_ARRAY =
          exports.DEFAULT_NODE_TYPE =
          exports.COMPONENT_METHOD =
            void 0;
        ...
        var NODE_TYPE_KEY = [
          ...
          "__isEmptyNode__",
          "__isPlainNode__",
          "__isFragmentNode__", // ====  object node ==== //
          "__isObjectNode__",
          "__isMemo__",
          "__isPortal__",
          "__isForwardRef__",
          "__isContextProvider__",
          "__isContextConsumer__", // ==== dynamic node ==== //
          "__isDynamicNode__",
        ...
        var SORT_BY_DEEP_HEAP = new CustomHeap(
          function (o1, o2) {
            return o1 > o2;
          },
          function (fiber) {
    ...
    39: [
      function (require, module, exports) {
        ...
        exports.updateAsyncTimeStep =
          exports.shouldYieldAsyncUpdate =
          exports.once =
          exports.mapFiber =
          exports.isNormalEqual =
          exports.isEqual =
          exports.flattenChildren =
          exports.cannotUpdate =
            void 0;
        ...
        var mapFiber = function mapFiber(arrayLike, action) {
          return (0, _children.mapByJudgeFunction)(
            arrayLike,
            function (f) {
      ...
      { "./children.js": 1, "./env.js": 19, "./fiber/index.js": 21 },
    ],
    40: [
      function (require, module, exports) {
        "use strict";
      ...
      { "./env.js": 19, "./fiber/index.js": 21, "./tool.js": 39 },
    ],
    41: [
      function (require, module, exports) {
        "use strict";
    ...
    47: [
      function (require, module, exports) {
        ...
        function cloneElement(element, props, children) {
          if (element instanceof _instance.MyReactVDom) {
            var clonedElement = _instance.createElement.apply(
              void 0,
              [
                element.type,
                Object.assign(
