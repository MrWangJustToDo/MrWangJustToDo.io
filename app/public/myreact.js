  ...
  ***************************************************************************** */
  ...
  var getTrackDevLog = function (fiber) {
    var _a, _b, _c, _d;
    {
      ...
      if (
        ...
        var name_1 =
          typedType.displayName ||
          ((_d = (_c = owner === null || owner === void 0 ? void 0 : owner.element) === null || _c === void 0 ? void 0 : _c.type) === null || _d === void 0
            ? void 0
            : _d.name);
  ...
  var getHookTree = function (hookType, newType) {
    ...
    for (var key in hookType) {
      ...
      var n = newType[key];
      re +=
        (+key + 1).toString().padEnd(6) + (c === null || c === void 0 ? void 0 : c.padEnd(20)) + (n === null || n === void 0 ? void 0 : n.padEnd(10)) + "\n";
    }
    re += "".padEnd(6) + "^".repeat(30) + "\n";
    return re;
  };
  var logHook = function (oldType, newType) {
    return getHookTree(oldType, newType);
  };
  var cache = {};
  var log = function (_a) {
    var fiber = _a.fiber,
